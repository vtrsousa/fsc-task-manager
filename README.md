...
If you are developing a production application, we recommend using TypeScript with type-aware lint rules enabled. Check out the [TS template](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-# FSC Task Manager

Sistema web para gestão simples de tarefas diárias, desenvolvido em React durante participação no Full Stack Club com foco em organização produtiva, experiência do usuário e aplicação de boas práticas de desenvolvimento.
